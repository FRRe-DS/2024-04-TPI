  ...
  return (
    <header >
      <nav>
        ...
        <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/f24694e27ccc4885e652c75170782aac661dd9e72ce330a4db559cdee1fa8a82?placeholderIfAbsent=true&apiKey=30d7ef0f40b54a82bd2a50ed0795d71c" alt="Menu" className={'menuIcon'} />
      </nav>
    </header>
  );
}
